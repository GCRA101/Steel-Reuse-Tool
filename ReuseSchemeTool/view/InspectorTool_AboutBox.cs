...
{
    public partial class InspectorTool_AboutBox : System.Windows.Forms.Form, model.Observer
    {
        //ATTRIBUTES
        private RST_Model model;

        public InspectorTool_AboutBox(RST_Model model)
        {
        ...
        {
            //Application Name
            this.lblProductName.Text = this.model.getModelName(Tool.INSPECTOR);
            //Application Version
