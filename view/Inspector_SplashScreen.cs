...
{
    public partial class Inspector_SplashScreen : Form, model.Observer
    {
        // ATTRIBUTES
        private RST_Model model;

        // CONSTRUCTOR
        public Inspector_SplashScreen(RST_Model model)
        {
        ...
        {
            //Application Name
            this.lblApplicationName.Text = this.model.getInspectorModelName();
            //Application Version
