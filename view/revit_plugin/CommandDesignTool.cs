...
namespace ReuseSchemeTool.view.revit_plugin
{
    ...
    public class CommandDesignTool : IExternalCommand
    {
        /*IMPLEMENTED METHODS*/
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            try
            {
                ...
                controller.initialize(Tool.DESIGN);
                ...
                if (controller.view.getAboutBox().ShowDialog() == DialogResult.OK) {
                    ...
                    controller.view.createProgressBarView(Tool.DESIGN);

                    revitTransaction.Start();

                    controller.model.initialize(commandData.Application);
                    controller.run(Tool.DESIGN);
                    ...
                    controller.terminate(Tool.DESIGN);
                }
